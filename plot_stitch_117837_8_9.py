...
def plot_stitch_117837_38_39_EPW(data):
    ### PLOT STITCHED H2 SHOCKS ###
    im1 = data['117837']['117837-12']['learned_parameters.csv']
    im2 = data['117838']['117838-8']['learned_parameters.csv']
    im3 = data['117839']['117839-9']['learned_parameters.csv']
    magI = 2.87
    r1 = shot_data.loc[117837,"pointing"] - im1["Radius (\\mum)"]/10**3  # convert to mm and shift 
    r2 = shot_data.loc[117838,"pointing"] - im2["Radius (\\mum)"]/10**3 
    r3 = shot_data.loc[117839,"pointing"] - im3["Radius (\\mum)"]/10**3
    ...
    f1_3 = im3["Te_electron"].rolling(window=window).mean()
    f2_3 = im3["ne_electron"].rolling(window=window).mean()
    ...
    std_f1_3 = im3["Te_electron"].rolling(window=window).std()
    std_f2_3 = im3["ne_electron"].rolling(window=window).std()
