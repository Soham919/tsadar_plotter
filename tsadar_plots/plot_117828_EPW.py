...
def plot_117828_EPW(data):
    lp = data['learned_parameters.csv']
    r = 4 + lp["Time (ps)"]/10**3
    bv = (r*10**2)/shot_data.loc[117828,"timing"]
...
def plot_117828_EPW_loss(data):
    lp_1 = data['117828-5']['learned_parameters.csv']   # learned parameters 1
    lp_2 = data['117828-8']['learned_parameters.csv']   # learned parameters 2
    r1 = shot_data.loc[117828,"pointing"] - lp_1["Radius (\\mum)"]/10**3   # radius 1
    r2 = shot_data.loc[117828,"pointing"] - lp_2["Radius (\\mum)"]/10**3   # radius 1
    loss_1 = data['117828-5']['losses.csv']   # loss 1
    loss_2 = data['117828-8']['losses.csv']   # loss 2
