...
def plot_117839_EPW(data):
    lp = data['learned_parameters.csv']
    r = shot_data.loc[117839,"pointing"] - lp["Radius (\\mum)"]/10**3
    bv = (r*10**2)/shot_data.loc[117839,"timing"]
...
def plot_117839_EPW_loss(data):
    lp_1 = data['117839-5']['learned_parameters']   # learned parameters 1
    lp_2 = data['117839-8']['learned_parameters']   # learned parameters 2
    r1 = shot_data.loc[117839,"pointing"] - lp_1["Radius (\\mum)"]/10**3   # radius 1
    r2 = shot_data.loc[117839,"pointing"] - lp_2["Radius (\\mum)"]/10**3   # radius 1
    loss_1 = data['losses.csv']   # loss 1
    loss_2 = data['losses.csv']   # loss 2
...
def plot_117839_IAW(data):
    ### PLOT LEARNED PARAMETERS for H2 AND HE SHOCKS ###
    im1 = data['117839']['117839-14']['learned_parameters.csv']
    ...
    r = shot_data.loc[117839,"pointing"] - im1["Radius (\\mum)"]/10**3
    #bv = (r*10**2)/shot_data.loc[92539,"timing"]
    ## Ti, Va, fract plot for all 3 species 
    plt.rcParams.update({
    #    "font.family": "serif",             # pick font family
    #    "font.serif": ["Arial"],  # pick specific font
